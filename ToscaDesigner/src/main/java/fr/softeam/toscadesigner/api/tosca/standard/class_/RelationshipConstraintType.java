...
public class RelationshipConstraintType implements IMdaProxy {
     ...
     */
    @objid ("0e4c2f51-3c3b-4dd6-b5ba-05d72b3446e4")
    ...
    public static final class MdaTypes {
        @objid ("18c144f8-bf2b-4eac-a275-6023aaad3ca4")
        public static Stereotype STEREOTYPE_ELT;

        @objid ("83968d6a-9fb6-4bd2-a45f-36ef2df65ecb")
        public static TagType CONSTRAINTTYPE_TAGTYPE_ELT;

        @objid ("e5de4df2-f6da-4f88-b6f4-b4e89244f860")
        public static TagType ANY_TAGTYPE_ELT;

        @objid ("09c0c114-9148-4546-a997-92b8134a22eb")
        private static Stereotype MDAASSOCDEP;

        @objid ("5d965854-963c-4ba0-a0a4-653df484bcc5")
