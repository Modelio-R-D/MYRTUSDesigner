...
public class TDeploymentArtifacts implements IMdaProxy {
    @objid ("cb113705-71cd-4580-b79f-4839efbe1df4")
    public static final String STEREOTYPE_NAME = "TDeploymentArtifacts";

    /**
     * The underlying {@link Class} represented by this proxy, never null.
     */
    @objid ("bd3373e4-62ad-49e5-8789-e34d284af7e6")
     ...
     */
    @objid ("b8ffb7c6-9c71-43c8-99f3-2ca0389accbf")
     ...
     */
    @objid ("ad5cc2b8-7933-4edd-a743-03495708dfce")
     ...
     */
    @objid ("2d0896a1-212b-4560-b689-211fd6f4560a")
     ...
     */
    @objid ("d10f471f-1995-4937-8860-e73bd45f8f0e")
     ...
     * 
     */
    @objid ("9d56ffcf-669a-4cff-9764-b97b3fe09d3c")
    ...
    @objid ("8fcacd86-1299-4301-a269-8b0a6b82ba26")
    @Override
     ...
     * 
     */
    @objid ("0e2a177a-eac2-4e36-8a33-b5b7e53d1db4")
     ...
     */
    @objid ("e4052aa4-77b3-42f9-914f-292ebf331c37")
    public Class getElement() {
        return this.elt;
    }

    @objid ("5fcfde1a-c716-4ae4-a59c-18828c13a755")
    @Override
    public int hashCode() {
     ...
     * 
     */
    @objid ("6304ec07-d30a-476e-a8c1-1389f2e232f1")
    ...
    @objid ("06be4a89-78e1-4f59-b449-36db8c729cf5")
    ...
    public static final class MdaTypes {
        @objid ("5ef75796-83d5-4f78-9f86-ac27ef812ff1")
        public static Stereotype STEREOTYPE_ELT;

        @objid ("c7679b19-3b8b-4436-ab19-a127a4dae6eb")
        private static Stereotype MDAASSOCDEP;

        @objid ("31a60a28-028c-4727-9e54-af6b0d540a3a")
        private static TagType MDAASSOCDEP_ROLE;

        @objid ("a3788d0f-f061-4d2a-bc14-33e89f00d924")
