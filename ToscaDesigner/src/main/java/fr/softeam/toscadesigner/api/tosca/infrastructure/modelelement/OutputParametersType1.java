...
public class OutputParametersType1 implements IMdaProxy {
    @objid ("c3acad99-aef5-4df0-ad51-11003753ef9e")
    public static final String STEREOTYPE_NAME = "OutputParametersType1";

    /**
     * The underlying {@link ModelElement} represented by this proxy, never null.
     */
    @objid ("dd8b6247-bb50-4127-a3bd-63ffc6176e85")
     ...
     */
    @objid ("5d319853-a59a-4bf7-ab39-4ccd99f2d202")
     ...
     */
    @objid ("1b108df9-1de5-4b25-8020-205c88c64248")
     ...
     */
    @objid ("8672116e-f565-4b7b-80df-8ca0fed03107")
     ...
     */
    @objid ("666e3682-ebe1-43ee-8c57-2cd8f029cc95")
     ...
     * 
     */
    @objid ("730071a6-9014-4de8-aa68-468cf781e664")
    ...
    @objid ("9c58ec03-5094-4bb6-9264-222492445f2e")
    @Override
     ...
     */
    @objid ("24e291a4-063d-4380-a8ea-84da32e9894d")
     ...
     * 
     */
    @objid ("82f0fc95-41b0-4bdd-ad1d-a005ec58f4ef")
    ...
    @objid ("54664e67-005c-41a3-b9cd-9c0937c07112")
    @Override
    public int hashCode() {
     ...
     * 
     */
    @objid ("5abce57a-aab9-45bc-95ad-402259b4c6ea")
    public boolean removeOutputParameter(final TParameter obj) {
        if (obj != null) {
          for (Dependency d : new ArrayList<>(this.elt.getDependsOnDependency())) {
            if (d.isStereotyped(OutputParametersType1.MdaTypes.MDAASSOCDEP) && Objects.equals(d.getTagValue(OutputParametersType1.MdaTypes.MDAASSOCDEP_ROLE), "outputParameter")) 
    ...
    @objid ("ddec1993-6a91-4fbb-913d-c18ee3fa0fbe")
    ...
    public static final class MdaTypes {
        @objid ("1f88065e-57ff-45f5-a0f2-d3683ce4e12d")
        public static Stereotype STEREOTYPE_ELT;

        @objid ("435b8e3e-05b4-496c-8780-8bf5463cecd1")
        private static Stereotype MDAASSOCDEP;

        @objid ("942893e1-8439-45ff-a7e7-9ac8317e8569")
        private static TagType MDAASSOCDEP_ROLE;

        @objid ("e04b419f-0dbf-4002-be45-f5b000f9c9b0")
