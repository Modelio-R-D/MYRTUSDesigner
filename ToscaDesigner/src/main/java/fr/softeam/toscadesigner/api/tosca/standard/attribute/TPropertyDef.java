...
public class TPropertyDef implements IMdaProxy {
    @objid ("1b13bcf9-27a3-4768-a580-7159196b4f79")
    public static final String STEREOTYPE_NAME = "TPropertyDef";

    /**
     * The underlying {@link Attribute} represented by this proxy, never null.
     */
    @objid ("654ee46c-1377-451c-bc46-cafd17f3783f")
     ...
     */
    @objid ("a84889fe-650b-4b89-828d-845c6a3ab9c9")
     ...
     */
    @objid ("308a0520-de86-4404-b5e5-5573c52e8b0e")
     ...
     */
    @objid ("a6df27d4-4485-4c0f-a44a-6b769f4b05d8")
     ...
     */
    @objid ("e915239f-dbe7-4606-a287-3639c6c9cbaf")
    ...
    @objid ("4bb87d5d-fb35-4812-9dd6-5e5a13ce00ed")
    @Override
     ...
     */
    @objid ("52b18ab8-c3b8-4883-9569-8147390d2998")
     ...
     * 
     */
    @objid ("91a4f89d-7e8f-4537-a0b6-c1f162884e2b")
    public PropertyDefinitionType getType() {
        for (Dependency d : this.elt.getDependsOnDependency()) {
              if (d.isStereotyped(TPropertyDef.MdaTypes.MDAASSOCDEP)
                  && Objects.equals(d.getTagValue(TPropertyDef.MdaTypes.MDAASSOCDEP_ROLE), "type")
    ...
    @objid ("d9e6c7cf-4cf2-47c6-896c-08b09191d37c")
    @Override
    public int hashCode() {
     ...
     * 
     */
    @objid ("32bc9eeb-906b-4e35-9cbf-84495a0783b8")
    public void setType(final PropertyDefinitionType obj) {
        Dependency dep = null;
        for (Dependency d : this.elt.getDependsOnDependency())
          if (d.isStereotyped(TPropertyDef.MdaTypes.MDAASSOCDEP) && Objects.equals(d.getTagValue(TPropertyDef.MdaTypes.MDAASSOCDEP_ROLE), "type")) {
             dep = d;
             break;
          }
        if (obj == null) {
          ...
          if (dep == null) {
              ...
              dep.setName("type");      dep.putTagValue(TPropertyDef.MdaTypes.MDAASSOCDEP_ROLE, "type");
          }
    ...
    @objid ("da4ca26b-178f-4616-9de5-db525fbb9d88")
    ...
    public static final class MdaTypes {
        @objid ("822a47dd-d989-43b7-ab4e-72042943d935")
        public static Stereotype STEREOTYPE_ELT;

        @objid ("59d7683d-05cd-4fa9-bea3-6496f58f0661")
        private static Stereotype MDAASSOCDEP;

        @objid ("b43a323e-5bce-4e78-aa5f-685aba1da8c2")
        private static TagType MDAASSOCDEP_ROLE;

        @objid ("5c3f8ebd-4835-40e8-b105-b204de08ef84")
