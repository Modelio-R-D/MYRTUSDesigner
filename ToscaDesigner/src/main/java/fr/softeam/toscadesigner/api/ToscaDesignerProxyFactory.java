...
public class ToscaDesignerProxyFactory {
     ...
     */
    @objid ("3098f75e-c4dc-42ab-b6ca-fc4dadcd6a82")
     ...
     * @return the right proxy or <i>null</i>.
     */
    @objid ("1c7834f5-79d4-489f-87be-2f3c2a52bfb1")
    public static final Object instantiate(final Element e, final String stName) {
        instantiateVisitor.setStereotype(stName);
        return e.accept(instantiateVisitor);
    }

    @objid ("8ed9a49d-f357-4cff-a297-bd20c65cb742")
    private static class InstantiateVisitor implements IDefaultInfrastructureVisitor, IDefaultModelVisitor {
        @objid ("e1aa3822-ff71-4a98-a475-178132fe7ca5")
        private String stName;

        @objid ("5f55e855-aa92-476d-a8eb-31271babed4c")
        public final void setStereotype(final String stName) {
            this.stName = stName;
        }

        @objid ("137c0775-94c8-4078-8db3-b7e4921052db")
        @Override
        ...
        @objid ("9bc6878d-3b54-42aa-bdf9-196ace3732a6")
        @Override
        ...
        @objid ("646f527c-34f5-46a3-ba19-0868ab1deca9")
        @Override
        ...
        @objid ("c7dc34d5-886c-48b0-b4db-d76e5e7f4ca2")
        @Override
        ...
        @objid ("2f73324a-8b59-4aeb-ab00-6dc9dad634f8")
        @Override
        ...
        @objid ("56112a24-3df8-4647-8241-7ce964440d87")
        @Override
         ...
         */
        @objid ("b28abc54-2aee-4ddb-a653-ec25127877d1")
        @Override
