...
public class TPlans implements IMdaProxy {
    @objid ("64af1581-e9aa-4608-a5ab-a6ef577872fe")
    public static final String STEREOTYPE_NAME = "TPlans";

    @objid ("7ee7455d-95b5-4a7e-b0ba-fbd0a126d3e6")
    public static final String TARGETNAMESPACE_PROPERTY = "targetNamespace";

    /**
     * The underlying {@link Class} represented by this proxy, never null.
     */
    @objid ("5ee8e227-eb62-4eeb-bd1f-3080be22b284")
     ...
     */
    @objid ("fad38bb9-3b0f-4024-96d2-9484f63a4cb3")
     ...
     */
    @objid ("997cf037-a3e0-4d61-ac10-19b163fc6f04")
     ...
     */
    @objid ("4e375aa3-e1b4-409a-81fb-5a2e3f32ed51")
     ...
     */
    @objid ("32d0c932-4550-4c34-a8f8-33b2099851bb")
     ...
     * 
     */
    @objid ("782e5ac4-86dc-44b5-927b-d0519a918e27")
    ...
    @objid ("3245cb8c-2418-4544-90b7-51450a5dd39f")
    @Override
     ...
     */
    @objid ("16d60c85-e749-4ac9-9433-86363335c90d")
     ...
     * 
     */
    @objid ("79b0d7be-7488-429c-8e00-163a4abd754f")
     ...
     * <br/><i>null</i></p>
     */
    @objid ("fe50bc70-9e53-44ce-9cc6-b4161ff16e54")
    ...
    @objid ("ad2b0458-aca5-4a24-af02-100045743dcc")
    @Override
    public int hashCode() {
     ...
     * 
     */
    @objid ("cda7e038-55d2-4c5f-8588-21080dec20e0")
    public boolean removePlans(final TPlan obj) {
        if (obj != null) {
          for (Dependency d : new ArrayList<>(this.elt.getDependsOnDependency())) {
            if (d.isStereotyped(TPlans.MdaTypes.MDAASSOCDEP) && Objects.equals(d.getTagValue(TPlans.MdaTypes.MDAASSOCDEP_ROLE), "plans")) 
     ...
     * <br/><i>null</i></p>
     */
    @objid ("d57960a1-59f9-44f5-833b-b6bdb0973e94")
    ...
    @objid ("a66c7173-8584-4dad-b365-7c13af0e979b")
    ...
    public static final class MdaTypes {
        @objid ("3035de70-039b-4687-889b-d76c5f86faa2")
        public static Stereotype STEREOTYPE_ELT;

        @objid ("78875177-69d3-48a2-b2be-5f343401adcb")
        public static PropertyDefinition TARGETNAMESPACE_PROPERTY_ELT;

        @objid ("3913e3bf-a32c-47d8-98fb-94cd5787c1c9")
        private static Stereotype MDAASSOCDEP;

        @objid ("6bdc62d5-c05f-43df-97c1-71849627b7e0")
        private static TagType MDAASSOCDEP_ROLE;

        @objid ("2424c255-4449-4af9-bdc1-e5eb89f8e042")
